    ...
    <>
      <div className="page-head">
        <div>
          ...
          <h1 className="h1">Agreements</h1>
          <p className="muted" style={{ margin: 0, maxWidth: "64ch" }}>
            Every liquidity agreement on {CLUSTER}, every check against it and what each one found. Anyone can run a check; the program decides what it means.
          </p>
        </div>
        <Link className="btn btn-primary" href="/app/draft"><FilePen />Draft with my operator</Link>
      </div>
